...
description: "Это короткая заметка о челендже под названием #100DaysOfCode и моем проекте в рамках этого челенджа. Я решил перенести игру Имаджинариум в онлайн и реализовать функцию загрузки карт. Теперь любая картинка может быть картой."
date: "2020-05-15"
lang: "rus"
type: "main"
...
![Онлайн-игра The Imagination: партия на мониторе рядом со звонком в Discord и на ноутбуке MacBook Pro](https://cloud.cdroma.me/upload/897ac9b6e3623895213a05df28efd2071590515216564.gif)
