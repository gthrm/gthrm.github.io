...
lang: "eng"
type: "main"
description: "As a developer, to create fast and reliable websites, it's crucial to understand every step a browser takes to display a web page, as each can be considered and optimized during development. This post is a brief overview of this process."
...
![Parsing HTML diagram: raw HTML is split into start tag, end tag and text tokens, which build the DOM tree](https://cloud.cdroma.me/upload/2900d46cf4572086bb3a71a2004f4bc81603967819483.png)
...
![Fetching external resources diagram: CSS blocks rendering, JavaScript blocks the parser unless the script has defer (waits until parsing is finished) or async (executes as soon as it loads)](https://cloud.cdroma.me/upload/de89cbe7244a704261ec4bd7d8a5bd131603969108205.png)
...
![Building the CSSOM diagram: CSS rules turn into a tree of inherited and overridden properties for body, div, p and span](https://cloud.cdroma.me/upload/e40b18af0d79d7d86179c457aa28005a1603970058277.jpeg)
...
![JavaScript execution timeline: sync, deferred and async scripts, with the document.DOMContentLoaded and window.load events](https://cloud.cdroma.me/upload/89913c1fdfbfb97c923543839a4ebe9c1603970486086.png)
...
![Render tree diagram: DOM and CSSOM are merged, non-visible head, link and script nodes and display: none elements are excluded](https://cloud.cdroma.me/upload/1211290eccd89fc9d039a0787e5628bd1603970868819.png)
...
![Layout diagram: HTML with layout styles becomes html, body, div, p and span boxes positioned on the page](<https://cloud.cdroma.me/upload/92b92971efe1e76b06f45518935c281f1603971427741.png>)
