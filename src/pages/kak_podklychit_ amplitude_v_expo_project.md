...
date: "2020-05-26"
---
![alt text](https://25mbcloud.ml/upload/a73a6017268863bc3232eff836c3ec251590507684094.png "Expo + Amplitude")
...
![// amplitude/config.js export const apiKey = '';](https://25mbcloud.ml/upload/5cc0869b1a747462c2cb48c1b8bca8951590508715755.png "// amplitude/config.js export const apiKey = ''")
...
![normalizeTrackingOptions](https://25mbcloud.ml/upload/173a6117019feff888cf74ee4b8dfb111590508947263.png "normalizeTrackingOptions")
...
![amplitude/events.js](https://25mbcloud.ml/upload/00d297e0dc9455e67ac9633dafd088281590509141543.png "amplitude/events.js")
...
![amplitude/index.js](https://25mbcloud.ml/upload/f8b320d7cb58a9c6d42cdfb691fb839b1590509442327.png "amplitude/index.js")

И ниже экспортируем events, это нужно для удобного доступа к ним.

![amplitude/index.js](https://25mbcloud.ml/upload/9877b33b90aa40a8e4ba289415494e031590509588590.png "amplitude/index.js")
...
![amplitude/index.js](https://25mbcloud.ml/upload/5024a14c01a794a7a60deb0d129c5ace1590510408687.png "amplitude/index.js")
...
![amplitude/index.js](https://25mbcloud.ml/upload/767e03e360a91f9f6c4ffaf1150b51101590510555332.png "amplitude/index.js")

---

1.2.9 Создадим фикцию **logEvent** для логирования событий в приложении

![amplitude/index.js](https://25mbcloud.ml/upload/5db520dd48141c52f26514d075f7e0a61590510724047.png "amplitude/index.js")
...
![amplitude/index.js](https://25mbcloud.ml/upload/073dea3d94a21270de34387c1bcc10961590510826996.png "amplitude/index.js")

Целиком **index.js** выглядит так:

![amplitude/index.js](https://25mbcloud.ml/upload/841ac12d4c681422f753099e55d0c03b1590510898814.png "amplitude/index.js")
...
![App.js](https://25mbcloud.ml/upload/9d9b8df2cb926ad1bcdaa99790f888451590511083596.png "App.js")
...
![App.js](https://25mbcloud.ml/upload/cbc7e840fcd6ecef4f884f1bf5bcb77d1590511391427.png "App.js")
...
![Переходим на сайт https://amplitude.com/ и жмём **Explore demo now**](https://25mbcloud.ml/upload/fbf7de218b23f68fdf378f2784f664df1590511548379.png "Переходим на сайт https://amplitude.com/ и жмём **Explore demo now**")

---

2.1.2 Вводим email

![Вводим email](https://25mbcloud.ml/upload/4e0f5813311b05421bbb71c00c0a04b41590511582694.png "Вводим email")

---

2.1.3 Выбираем направленность вашего приложения, например **Media** и жмём **Next**

![Выбираем направленность вашего приложения](https://25mbcloud.ml/upload/ef7c4cf8aec226615d57daac4e44b43d1590511664969.png "Выбираем направленность вашего приложения")

---

2.1.4 Вводим свои данные

![Вводим свои данные](https://25mbcloud.ml/upload/d2b94b89bac6404a973a0a415fa236501590511712055.png "Вводим свои данные")
...
![демо версия с различными метриками](https://25mbcloud.ml/upload/446c8ff68faea4c7874730c97b33b3751590511784799.png "демо версия с различными метриками")

---

2.1.5 Идем в почту, находим письмо от Amplitude, переходим по ссылке, вводим данные в форму и жмём **Activate**

![Activate](https://25mbcloud.ml/upload/217438033c3672a72dc07876801be5dd1590511855826.png "Activate")

---

2.1.6 Теперь, когда мы уже все проверили, изучили и подтвердили, в самом верху страницы жмём кнопку **Set up on the Free Plan**

![Set up on the Free Plan](https://25mbcloud.ml/upload/453674a4918d37a31c9ded2b9db70ad31590511925197.png "Set up on the Free Plan")
...
![Create](https://25mbcloud.ml/upload/8ab933098f8e3a02cc54d3f544310d8b1590513017669.png "Create")
...
![Create Project](https://25mbcloud.ml/upload/78c077f1e7db771eb9cc5fc3451e8ed51590513175963.png "Create Project")

![Create Project](https://25mbcloud.ml/upload/9eb555cf6184a91c4a7cfbeeacf9d2cc1590513235774.png "Create Project")
...
![Add Data Source](https://25mbcloud.ml/upload/66391f4ab3af4820391abed1ea0ce9611590513353394.png "Add Data Source")

---

2.2.3 Выбираем iOS SDK и жмём **Next** и снова **Next**

![iOS SDK](https://25mbcloud.ml/upload/27fc24a1f6073df92eba6b412f672c401590513419484.png "iOS SDK")

![iOS SDK](https://25mbcloud.ml/upload/364c6209edc9a1258486a85175c657e91590513471040.png "iOS SDK")

Сейчас Amplitude ждёт события от приложения.

Как только событие будет отправлено, Amplitude получит его и укажет здесь.

![Amplitude ждёт события от приложения](https://25mbcloud.ml/upload/6ba084544cad9fddc5a28386609b3ad01590513527355.png "Amplitude ждёт события от приложения")
...
![Amplitude получит наше событие из приложения](https://25mbcloud.ml/upload/11bf25f5d20e1fdb237b46c8c32dcfe81590513671203.png "Amplitude получит наше событие из приложения")
